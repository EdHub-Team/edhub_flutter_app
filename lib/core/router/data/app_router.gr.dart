...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    CompeteRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const CompetePage(),
      );
    },
    GenerateQuizRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const GenerateQuizPage(),
      );
    },
...
/// generated route for
/// [CompetePage]
class CompeteRoute extends PageRouteInfo<void> {
  const CompeteRoute({List<PageRouteInfo>? children})
      : super(
          CompeteRoute.name,
          initialChildren: children,
        );

  static const String name = 'CompeteRoute';
...
/// generated route for
/// [GenerateQuizPage]
class GenerateQuizRoute extends PageRouteInfo<void> {
  const GenerateQuizRoute({List<PageRouteInfo>? children})
      : super(
          GenerateQuizRoute.name,
          initialChildren: children,
        );

  static const String name = 'GenerateQuizRoute';
